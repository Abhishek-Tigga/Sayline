...
final class MeetingCoordinator {
    ...
    func join() async {
        ...
        // The name is always announced. A wrong pick is then visible at the
        // moment it happens rather than after you have joined the wrong
        // call — which is the whole reason the design accepted a simple
        // soonest-start rule instead of something cleverer.
